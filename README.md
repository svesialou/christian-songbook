...
- Пока online-синхронизация каталога выполняется, приложение блокирует скролл прозрачным loading overlay; offline открывает сохранённый каталог сразу, а пустой каталог подсказывает pull-to-refresh.
