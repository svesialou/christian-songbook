...
- Поиск в основном списке песен остаётся закреплённым сверху при прокрутке каталога, ищет по заголовку и тексту песни, подсвечивает найденные слова и игнорирует регистр и знаки препинания между словами.
