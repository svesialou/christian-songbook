...
- Поиск в основном списке песен остаётся закреплённым сверху при прокрутке каталога, ищет по словам и игнорирует регистр и знаки препинания между словами.
