...
## Данные и кэш
- Phase 1 источник данных: встроенный единый каталог приложения.
...
1. На первом старте загружается shell PWA и встроенный каталог.
...
4. Интерфейс работает без интернета на последнем локальном snapshot.
